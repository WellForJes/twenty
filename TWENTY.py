...
if not api_key or not api_secret:
    raise ValueError("❌ Не заданы API ключи. Убедитесь, что файл .env содержит BINANCE_API_KEY и BINANCE_API_SECRET")
...
def send_status_to_telegram():
    ...
    try:
        ...
        positions_text = "\n".join(positions_info) if positions_info else "Нет открытых позиций."
